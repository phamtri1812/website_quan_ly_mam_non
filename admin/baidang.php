                ...
                <div id="baidang">
                    ...
                    <script>
                        ...
                        function DeleteImg(row){
                            var result=confirm("Bạn muốn xóa những hình ảnh này ?");
                            if(result){
                                document.getElementById("frame").style.display='block';
                                var i=row.parentNode.parentNode.rowIndex;
                                var cd=document.getElementById("table-anh").rows[i].cells[0].innerHTML;
                    ...
                    <Label style="margin-left: 50px;"><b>Năm học</b></Label>
                    <select id="nam-img">
                        <option>Tất cả</option>
                        <?php
                ...
                <div id="dang-sua">
                    ...
                    <br>
                        ...
                        <form method="post" action="baidang-data.php" enctype="multipart/form-data">
                            ...
                            <input name='diadiem' type="text" style="width: 330px;"><br><br>
                            <Label style="margin-left: 50px;"><b>Chủ đề</b></Label>
                            <input name='chude' type="text" style="width: 350px;">
