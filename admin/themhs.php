<?php
   ...
   if (isset($_FILES['anhcha']))
        ...
        $sql="INSERT INTO hocsinh(HOTENHS,NGAYSINH,GIOITINH,DIACHI,NGAYNHAPHOC,HOTENCHA,SDTCHA,HOTENME,SDTME,MSLOP,ANHHS,ANHCHA,ANHME) 
                        VALUES('".$_POST["hotenhs"]."', '".$_POST["ngaysinh"]."', '".$_POST["gioitinh"]."', '".$_POST["diachi"]."',
                        '".$_POST["ngaynhaphoc"]."',  '".$_POST["hotencha"]."', '".$_POST["sdtcha"]."',
                        '".$_POST["hotenme"]."', '".$_POST["sdtme"]."', '".$_POST["malop"]."', '".$namehs."', '".$namecha."','".$nameme."')";
