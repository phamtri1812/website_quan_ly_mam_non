        ...
        <div id='content'>
            ...
            <div id='xemimg'>
                ...
                <?php
                    ...
                    $q=$conn->query("SELECT DISTINCT NAMHOC FROM chuongtrinhhoc");
                    while($rn=$q->fetch_assoc()){
                        echo "<option>".$rn["NAMHOC"]."</option>";

                    }
                    echo "</select>";

                    #select khối
                    echo "<b style='margin-left: 20px;'>Khối: </b><select id='khoi'>
                    <option>Tất cả</option>";

                    $q=$conn->query("SELECT * FROM  khoi");
                    while($rn=$q->fetch_assoc()){
                        echo "<option value='".$rn["MAKHOI"]."'>".$rn["TENKHOI"]."</option>";
                    ...
                    <div id='hframe'>
                        <?php
                            ...
                            $q2=$conn->query("SELECT*FROM chuongtrinhhoc ORDER BY NAMHOC DESC");
                            echo "<ul id='listimg'>";
