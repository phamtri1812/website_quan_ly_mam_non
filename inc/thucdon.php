...
<html>
    ...
    <body>
        <div id='content'>
            ...
            <div id='xemimg'>
                <br><br>
                <b style='margin-left: 100px;'>Tháng: </b>
                <select id='thang'>
                ...
                <?php
                    ...
                    echo "<b style='margin-left: 20px;'>Năm: </b><select id='nam-img'>
                        <option>Tất cả</option>";
                    $q=$conn->query("SELECT DISTINCT NAM FROM thucdon ");
                    while($rn=$q->fetch_assoc()){
                        echo "<option>".$rn["NAM"]."</option>";
                    ...
                    <div id='hframe'>
                        <?php
                            ...
                            $q2=$conn->query("SELECT*FROM thucdon ORDER BY NAM DESC, THANG DESC");
                            echo "<ul id='listimg'>";
